...
<head>
  <meta charset="UTF-8">
  <title>ชุดใบงานภารกิจโค้ดดิ้ง ป.5 (ฉบับพิมพ์หน้า-หลัง 2 แผ่นจบ) - ครูเตชินท์ อินทมล</title>
...
<body>
  ...
  <div class="print-bar no-print">
    <div>
      <strong>📄 ชุดใบงานภารกิจโค้ดดิ้ง ป.5 (ฉบับพิมพ์หน้า-หลัง 2 แผ่น จบครบ 4 ภารกิจ)</strong><br>
      <span style="font-size: 11pt; color: #cbd5e1;">คำแนะนำ: ตั้งค่าเครื่องพิมพ์เป็น "Print on both sides (Flip on long edge)" จะได้กระดาษ 2 แผ่นพอดี</span>
    </div>
  ...
  <div class="page">
    <div style="display: flex; justify-content: space-between; align-items: center;">
      ...
      <span style="font-size: 10pt; color: #64748b;">รหัสวิชา ว15101 วิทยาการคำนวณ ป.5</span>
    </div>
    ...
    <table class="team-table">
      <tr>
        ...
        <th style="width: 38%;">บทบาทประจำภารกิจที่ 1</th>
      </tr>
      <tr>
        <td>ชื่อทีม: ............................................................................</td>
    ...
    <table class="grid-table">
      <tr>
        <th>แถว/คอลัมน์</th><th>C1</th><th>C2</th><th>C3</th><th>C4</th><th>C5</th><th>C6</th>
      </tr>
      <tr>
    ...
    <div class="write-box">
      ...
      2. ต้องทำชุดคำสั่งนี้ซ้ำติดต่อกันทั้งหมด: <strong>.................... รอบ</strong> &nbsp;&nbsp;(ใช้บล็อกลูป: <strong>[ วนซ้ำ Loop ............ รอบ ]</strong>)<br>
  ...
  <div class="page">
    <div style="display: flex; justify-content: space-between; align-items: center;">
      ...
      <span style="font-size: 10pt; color: #dc2626; font-weight: 700;">🔄 สลับบทบาทคู่หูแล้ว!</span>
    </div>
    ...
    <table class="team-table">
      <tr>
        <th style="width: 50%;">ข้อมูลคู่หู Active Learning</th>
        <th style="width: 12%;">เลขที่</th>
        <th style="width: 38%;">บทบาทประจำภารกิจที่ 2 (สลับหน้าที่)</th>
      </tr>
      <tr>
        <td>ชื่อทีม: ............................................................................</td>
        <td style="text-align: center;">-</td>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 10px;">
      <div class="write-box" style="margin-bottom: 0;">
        ...
        4. เลี้ยวขวา<br>
        <span style="font-size: 10.5pt; color: #64748b;">(ใช้โค้ดยาวถึง 12-16 บล็อก เสียเวลามาก!)</span>
      </div>
      <div class="write-box" style="margin-bottom: 0; background: #f0fdf4; border-color: #86efac;">
        ...
        <span style="font-size: 10.5pt; color: #15803d; font-weight: 700;">(ประหยัดบล็อกเหลือเพียง 1 ลูปสั้นๆ!)</span>
      </div>
    </div>
  ...
  <div class="page">
    ...
    <table class="team-table">
      <tr>
        <th style="width: 50%;">ข้อมูลคู่หู Active Learning</th>
        <th style="width: 12%;">เลขที่</th>
        <th style="width: 38%;">บทบาทประจำภารกิจที่ 3</th>
      </tr>
      <tr>
        <td>ชื่อทีม: ............................................................................</td>
        <td style="text-align: center;">-</td>
  ...
  <div class="page">
    ...
    <table class="team-table">
      <tr>
        <th style="width: 50%;">ข้อมูลคู่หู Active Learning</th>
        <th style="width: 12%;">เลขที่</th>
        <th style="width: 38%;">บทบาทประจำภารกิจที่ 4 (สลับหน้าที่)</th>
      </tr>
      <tr>
        <td>ชื่อทีม: ............................................................................</td>
        <td style="text-align: center;">-</td>
...
print("Created Perfect Duplex HTML Worksheets successfully!")
